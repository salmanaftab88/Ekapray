...
class Update extends React.Component {
    constructor(props) {
        ...
        this.state.obj = props.nkidsproducts.filter((item) => {
            return item._id === props.match.params.kidsid;
...
let NewVM = connect(function (store) {
    ...
    return {
        nkidsproducts: store.imgReducer.kidProducts,
    }
