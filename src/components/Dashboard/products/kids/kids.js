    ...
    render() {
        ...
        const renderTodos = currentTodos.map((todo, index) => {
            return <div data-aos="fade-zoom-in"
                ...
                <div className="kids-product-additional">
                    <Link to={"/kidsCollection/" + todo.description}>
                        <img style={{ width: "210px", height: "310px" }} id="kids-product-set" src={todo.file ? todo.file[0] : ''} />
                    </Link>
                    {/* {console.log(todo)} */}

                    <div className="kids-quick">
                        <Button id="kids-quick" onClick={() => this.toggle(todo.price, todo.description, todo.file, todo.saleprice)}  >{this.props.buttonLabel}Quick View</Button>
                ...
                {this.Authen.loggedIn() ? (
                    <div>
                        ...
                        <Link to={"/kidsupdate/" + todo._id} ><button>update</button></Link>
                    </div>
                ) : null}
            </div>;
        })
                ...
                <div>
                    ...
                    >
                        ...
                        <DialogContent>
                            ...
                            />
                            <input type='file' name='file' id='myFile' onChange={this.handleimg} />
